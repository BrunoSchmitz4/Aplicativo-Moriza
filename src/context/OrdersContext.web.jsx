// Versão WEB: o expo-sqlite não roda no navegador sem configuração extra,
// então na Web os pedidos são persistidos no AsyncStorage (que usa o
// localStorage). A API pública é idêntica à da versão nativa (SQLite),
// por isso as telas funcionam igual nas duas plataformas.
...
export function OrdersProvider({ children }) {
  ...
  // Carrega os pedidos salvos ao iniciar o app
  useEffect(() => {
    (async () => {
      try {
